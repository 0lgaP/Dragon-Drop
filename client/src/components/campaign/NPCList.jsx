...
=======
    <section className="flex flex-row ">
      <div className="bg-primary m-2 p-4">
        <h1 className="text-2xl text-textcolor p-2 mt-4">Create a new NPC!</h1>
>>>>>>> a5247fdbe8db7e8ffa426c6453eebba656688bb2
      <form className="p-2 m-2">
          <label className="">
            <p className="text-textcolor text-lg p-2 m-2">Name</p>
            <input className="border-2 border-secondary rounded-md bg-bkgd mb-4 w-60" type="text" onChange={e => setName(e.target.value)} value={name} />
          </label>
          <label className="">
          ...
          <label>
            ...
            <input className="border-2 border-secondary rounded-md bg-bkgd mb-4 h-40 w-60" type="text" onChange={e => setBio(e.target.value)} value={bio} />
          </label>
          <label>
            <p className="text-textcolor text-lg p-2 m-2">DM Notes</p>
            <input className="border-2 border-secondary rounded-md bg-bkgd mb-4 w-60 h-20" type="text" onChange={e => setDetails(e.target.value)} value={details} />
          </label>
